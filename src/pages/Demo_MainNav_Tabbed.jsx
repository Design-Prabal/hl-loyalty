...
const SECTION_TABS = ['Social planner', 'Emails', 'Snippets', 'Countdown timer', 'Brand boards', 'Ad manager', 'Loyalty']
...
export default function Demo_MainNav_Tabbed() {
  ...
  const actions = isLoyalty ? null : (
    <div className="flex items-center gap-1.5">
      ...
      <button className="h-8 px-3 flex items-center gap-1 text-[13px] font-semibold text-white bg-[#004EEB] rounded-lg hover:bg-[#0040C9] transition-colors">
        <Plus size={12} />
        New post
      </button>
    </div>
  ...
  return (
    <AppShell
      ...
      topbarProps={{
        ...
        subTabs: isLoyalty ? [] : SUB_TABS,
        activeSubTab: isLoyalty ? '' : activeSubTab,
        onSubTabChange: isLoyalty ? undefined : setActiveSubTab,
        actions,
      }}
    >
